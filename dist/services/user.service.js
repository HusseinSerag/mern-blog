...
function getUser(id) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!user) {
                throw new CustomError_1.CustomError("User doesn't exist", 404);
            }
            return user;
        }
        catch (e) {
...
function getUsers(query) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const api = new apiServices_1.API(user_model_1.default.find().select("-password"));
            api
                .filter(Object.assign({}, rest))
                .sort(sort);
            const { totalLength } = yield api.limit(page, limit);
            const users = yield api.query;
            return {
